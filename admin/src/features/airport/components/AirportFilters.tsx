...
import type { IAirportFilter } from "@/features/airport/types";
...
interface Props {
  filters: IAirportFilter;
  onFilterChange: (key: keyof IAirportFilter, value: unknown) => void;
  onReset: () => void;
}

export function AirportFilters({ filters, onFilterChange, onReset }: Props) {
  return (
