...
import type { IAirlineFilter } from "@/features/airline/types";
...
interface Props {
  filters: IAirlineFilter;
  onFilterChange: (key: keyof IAirlineFilter, value: unknown) => void;
  onReset: () => void;
}

export function AirlineFilters({ filters, onFilterChange, onReset }: Props) {
  return (
