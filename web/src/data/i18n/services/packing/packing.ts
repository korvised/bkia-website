...
export const packing = {
  ...
  prohibitedNote: {
    ...
    lo: "ລາຍການຕໍ່ໄປນີ້ບໍ່ສາມາດຫຸ້ມຫໍ່ ຫຼື ຝາກເປັນກະເປົ໋າໃຕ້ທ້ອງເຄື່ອງໄດ້. ກະລຸນາກວດສອບລະບຽບການຂອງສາຍການບິນ ແລະ ພາສີຢ່າງລະອຽດ.",
    zh: "以下物品严禁包装或作为托运行李运输。请在打包前查阅航空公司及海关规定。",
  },
  readMoreLabel: {
    en: "Full Baggage Regulations",
    lo: "ລະບຽບການກ່ຽວກັບກະເປົ໋າທັງໝົດ",
    zh: "完整行李规定详情",
  },
  locationLabel: {
    en: "Find Us",
...
export const PACKING_BENEFITS: Record<Lang, PackingBenefit[]> = {
  ...
  lo: [
    ...
    },
    {
      ...
      desc: "ການຫຸ້ມຫໍ່ທີ່ປ້ອງກັນການງັດແງະ ຊ່ວຍຢັບຢັ້ງການເຂົ້າເຖິງກະເປົ໋າໂດຍບໍ່ໄດ້ຮັບອະນຸຍາດ",
    },
    {
    ...
    {
      label: "ກະເປົ໋າ, ສິ່ງຂອງແຕກຫັກງ່າຍ ແລະ ເອກະສານ",
      desc: "ເໝາະສຳລັບກະເປົ໋າເດີນທາງ, ພັດສະດຸທີ່ແຕກຫັກງ່າຍ ແລະ ແຟ້ມເອກະສານ",
    },
  ],
  zh: [
    {
...
export const PACKING_SIZES: Record<Lang, PackingSize[]> = {
  ...
  lo: [
    { key: "small",  label: "ຂະໜາດນ້ອຍ", sublabel: "ພັດສະດຸຖືຂຶ້ນເຄື່ອງ / ກະເປົ໋າຖື",     lak: "15,000",  thb: "25",  cny: "5"  },
