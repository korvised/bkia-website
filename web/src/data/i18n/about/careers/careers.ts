...
export const careers = {
  ...
  noPositions: {
    en: "No open positions at this time. Check back soon.",
    lo: "ຍັງບໍ່ມີຕໍາແໜ່ງທີ່ເປີດຮັບໃນຂະນີ້. ກະລຸນາກວດສອບໃໝ່ໃນໄວໆນີ້.",
    zh: "暂无招聘职位，请稍后再查看。",
  },
  vacancy: {
    en: "opening",
  ...
  applySubtitle: {
    en: "Send your application documents directly to our HR department.",
    lo: "ສົ່ງເອກະສານສະໝັກຂອງທ່ານໂດຍກົງໄປຍັງພະແນກ HR.",
    zh: "请将您的申请材料直接发送至人力资源部门。",
  },
  positionNotFound: {
  ...
  positionNotFoundMessage: {
    en: "This position may have been filled or removed. Browse all open positions.",
    lo: "ຕໍາແໜ່ງນີ້ອາດຖືກປ່ຽນແປງ ຫຼື ລຶບອອກແລ້ວ. ເບິ່ງຕໍາແໜ່ງທັງໝົດ.",
    zh: "该职位可能已填满或已下架，请浏览所有开放职位。",
  },

  // Culture section
  cultureLabel: {
    lo: "ຄ່ານິຍົມ ແລະ ວັດທະນະທຳ",
    en: "Our Culture",
    zh: "企业文化",
  },
  cultureHeadline: {
    lo: "ສ້າງຂຶ້ນດ້ວຍເປົ້າໝາຍ,\nຂັບເຄື່ອນດ້ວຍບຸກຄະລາກອນ", // "Built on Aspiration, Driven by Service Mind"
    en: "Built on Purpose,\nDriven by People",
    zh: "以使命为基础，\n以人才为驱动",
  },
  cultureBody: {
    lo: "ທີ່ BKIA, ພວກເຮົາເຊື່ອວ່າສະໜາມບິນເປັນຫຼາຍກວ່າບ່ອນຂຶ້ນ-ລົງຍົນ. ແຕ່ແມ່ນບ່ອນທີ່ຄອບຄົວໄດ້ກັບມາພົບໜ້າກັນ, ເປັນຈຸດເລີ່ມຕົ້ນຂອງການຂະຫຍາຍຕົວທາງທຸລະກິດ ແລະ ເປັນດ່ານທຳອິດທີ່ຕ້ອນຮັບແຂກບ້ານ-ແຂກເມືອງ ດ້ວຍນ້ຳໃຈໄມຕີຈິດແບບລາວເຮົາ.",
...
export type CareersKey = keyof typeof careers;
...
// ── Culture values (trilingual) ──────────────────────────────────────────────
export const careersValuesData: Record<
  Lang,
...
> = {
  en: [
    ...
    {
      title: "Grow Together",
      body: "We invest in every team member's future, because when our people grow, BKIA grows.",
    },
  ],
  lo: [
    {
    ...
    {
      title: "ບໍລິການດ້ວຍໃຈ",
      body: "ພວກເຮົາພ້ອມມອບການຕ້ອນຮັບທີ່ອົບອຸ່ນແບບລາວແທ້ ໃນທຸກໆຂັ້ນຕອນການບໍລິການ ນັບແຕ່ເຄົາເຕີເຊັກອິນ ຈົນເຖິງຫໍບັງຄັບການບິນ.",
    },
    {
      title: "ເຕີບໂຕໄປພ້ອມກັນ",
      body: "ພວກເຮົາເອົາໃຈໃສ່ພັດທະນາທ່າແຮງຂອງພະນັກງານທຸກຄົນ ເພາະຄວາມກ້າວໜ້າຂອງທ່ານ ຄືຄວາມສຳເລັດຂອງ BKIA.",
    },
  ],
  zh: [
    {
...
// ── Short benefit labels for icon grid ───────────────────────────────────────
export const careersBenefitsShort: Record<Lang, string[]> = {
  en: [
    "Free Housing",
    "Overtime Pay",
    "Meal Allowance",
