...
export default function SurveyPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      {/* CTA */}
      <div className="bg-gradient-to-r from-[#5CBEC6] to-[#00AAAC] px-4 py-8 text-white sm:px-6 sm:py-10 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="mb-3 text-xl font-bold sm:text-2xl">
            Learn More About Our Airport
          </h2>
          <p className="mb-6 text-sm opacity-90 sm:text-base">
            Explore detailed information about our facilities, services, and
            operations
          </p>
          <div className="flex flex-col gap-3 sm:flex-row sm:justify-center sm:gap-4">
            <button className="inline-flex items-center justify-center gap-2 rounded-lg bg-white px-6 py-2.5 text-sm font-semibold text-[#00AAAC] transition-all hover:bg-gray-100 hover:shadow-lg">
              <Download className="h-4 w-4" />
              Download Airport Guide
            </button>
            <button className="inline-flex items-center justify-center gap-2 rounded-lg border-2 border-white px-6 py-2.5 text-sm font-semibold text-white transition-all hover:bg-white hover:text-[#00AAAC]">
