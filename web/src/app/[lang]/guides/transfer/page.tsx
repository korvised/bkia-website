    ...
    <div className="space-y-8">
      ...
      <div className="flex items-start gap-6">
        <div className="flex-shrink-0">
          <div className="bg-bokeo-teal-100 flex h-20 w-20 items-center justify-center rounded-xl">
            <RefreshCcw className="text-bokeo-teal-600 h-10 w-10" />
          </div>
        </div>
      ...
      <div className="rounded-r-lg border-l-4 border-orange-500 bg-orange-50 p-5">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="mb-1 font-semibold text-gray-900">Important:</p>
            <p className="leading-relaxed text-gray-700">
      ...
      <div className="from-bokeo-teal-50 to-bokeo-teal-100 border-bokeo-teal-200 rounded-xl border bg-gradient-to-br p-6">
        <h2 className="mb-5 flex items-center gap-2 text-xl font-bold text-gray-900">
          <Plane className="text-bokeo-teal-600 h-6 w-6" />
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {airlines.map((airline, index) => (
            <div
              key={index}
              className="border-bokeo-teal-200 rounded-lg border bg-white p-5 transition-shadow hover:shadow-md"
            >
              <div className="flex flex-col items-center text-center">
                <div className="relative mb-3 flex h-24 w-24 items-center justify-center overflow-hidden rounded-lg">
                ...
                <h3 className="mb-1 font-bold text-gray-900">{airline.name}</h3>
                <span className="bg-bokeo-teal-50 rounded-full px-3 py-1 text-sm text-gray-600">
                  {airline.code}
                </span>
              </div>
            </div>
      ...
      <div className="rounded-xl border border-gray-200 bg-white p-8">
        ...
        <div className="space-y-6">
          ...
          <div className="flex gap-4">
            <div className="flex-shrink-0">
              <div className="bg-bokeo-teal-600 flex h-10 w-10 items-center justify-center rounded-full text-lg font-bold text-white">
                1
              </div>
            </div>
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-grow pt-1">
              ...
              <div className="grid gap-3 md:grid-cols-2">
                <div className="bg-bokeo-teal-50 border-bokeo-teal-200 rounded-lg border p-4">
            ...
            <div className="flex-grow pt-1">
              ...
              <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
                <div className="flex items-start gap-2 text-sm text-gray-700">
                  <ShieldCheck className="text-bokeo-teal-600 mt-0.5 h-5 w-5 flex-shrink-0" />
      ...
      <div className="rounded-xl border border-gray-200 bg-white p-8">
        <div className="mb-6 flex items-center gap-3">
          <Clock className="text-bokeo-teal-600 h-6 w-6" />
          <div>
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="bg-bokeo-teal-600 text-white">
                <th className="border-bokeo-teal-700 border px-6 py-4 text-left font-semibold">
                  Transfer Type
                </th>
                <th className="border-bokeo-teal-700 border px-6 py-4 text-center font-semibold">
                  Same Terminal
                </th>
                <th className="border-bokeo-teal-700 border px-6 py-4 text-center font-semibold">
                  Different Terminal
            ...
            <tbody>
              <tr className="bg-bokeo-teal-50 hover:bg-bokeo-teal-100 transition-colors">
                <td className="border border-gray-300 px-6 py-4 font-medium text-gray-900">
                  Domestic to Domestic
                </td>
                <td className="border border-gray-300 px-6 py-4 text-center font-bold text-gray-900">
                  60 minutes
                </td>
                <td className="border border-gray-300 px-6 py-4 text-center font-bold text-gray-900">
                  90 minutes
        ...
        <div className="mt-5 rounded-r-lg border-l-4 border-orange-500 bg-orange-50 p-4">
          <div className="flex items-start gap-3">
      ...
      <div className="rounded-xl border border-gray-200 bg-gradient-to-br from-gray-50 to-gray-100 p-6">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div className="rounded-lg border border-gray-200 bg-white p-5">
            <div className="flex items-start gap-3">
              <MapPin className="text-bokeo-teal-600 mt-1 h-5 w-5 flex-shrink-0" />
              <div>
                <h4 className="mb-1 font-semibold text-gray-900">
                  Transfer Counter
                </h4>
                <p className="mb-2 text-sm text-gray-700">Main arrivals hall</p>
                <p className="text-bokeo-teal-600 text-sm font-medium">
          ...
          <div className="rounded-lg border border-gray-200 bg-white p-5">
            <div className="flex items-start gap-3">
              <Users className="text-bokeo-teal-600 mt-1 h-5 w-5 flex-shrink-0" />
              <div>
                <h4 className="mb-1 font-semibold text-gray-900">
                  Airport Information
                </h4>
