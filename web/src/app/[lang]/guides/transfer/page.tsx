    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:gap-6">
        <div className="flex-shrink-0">
          <div className="bg-bokeo-teal-100 flex h-16 w-16 items-center justify-center rounded-xl sm:h-20 sm:w-20">
            <RefreshCcw className="text-bokeo-teal-600 h-8 w-8 sm:h-10 sm:w-10" />
          </div>
        </div>
      ...
      <div className="from-bokeo-teal-50 to-bokeo-teal-100 border-bokeo-teal-200 rounded-xl border bg-gradient-to-br p-4 sm:p-6">
        <h2 className="mb-4 flex items-center gap-2 text-lg font-bold text-gray-900 sm:mb-5 sm:text-xl">
          <Plane className="text-bokeo-teal-600 h-5 w-5 sm:h-6 sm:w-6" />
        ...
        <div className="grid gap-3 sm:grid-cols-2 sm:gap-4 lg:grid-cols-3">
          {airlines.map((airline, index) => (
            <div
              key={index}
              className="border-bokeo-teal-200 rounded-lg border bg-white p-4 transition-shadow hover:shadow-md sm:p-5"
            >
              <div className="flex flex-col items-center text-center">
                ...
                <span className="bg-bokeo-teal-50 rounded-full px-3 py-1 text-xs text-gray-600 sm:text-sm">
                  {airline.code}
                </span>
              </div>
            </div>
      ...
      <div className="rounded-xl border border-gray-200 bg-white p-5 sm:p-8">
        ...
        <div className="space-y-5 sm:space-y-6">
          ...
          <div className="flex gap-3 sm:gap-4">
            <div className="flex-shrink-0">
              <div className="bg-bokeo-teal-600 flex h-9 w-9 items-center justify-center rounded-full text-base font-bold text-white sm:h-10 sm:w-10 sm:text-lg">
                1
              </div>
            </div>
            ...
            <div className="flex-grow pt-0.5 sm:pt-1">
              ...
              <div className="rounded-lg border border-gray-200 bg-gray-50 p-3 sm:p-4">
                <div className="flex items-start gap-2 text-xs text-gray-700 sm:text-sm">
                  <ShieldCheck className="text-bokeo-teal-600 mt-0.5 h-4 w-4 flex-shrink-0 sm:h-5 sm:w-5" />
              ...
              <div className="bg-bokeo-teal-50 border-bokeo-teal-200 rounded-lg border p-3 sm:p-4">
                <div className="grid gap-3 text-xs sm:grid-cols-2 sm:text-sm">
                  <div className="flex items-start gap-2">
                    <Clock className="text-bokeo-teal-600 mt-0.5 h-4 w-4 flex-shrink-0 sm:h-5 sm:w-5" />
                    <div>
      ...
      <div className="rounded-xl border border-gray-200 bg-white p-5 sm:p-8">
        <div className="mb-5 flex items-start gap-3 sm:mb-6 sm:items-center">
          <Clock className="text-bokeo-teal-600 mt-1 h-5 w-5 flex-shrink-0 sm:mt-0 sm:h-6 sm:w-6" />
          <div>
          ...
          <table className="w-full border-collapse text-sm sm:text-base">
            <thead>
              <tr className="bg-bokeo-teal-600 text-white">
                <th className="border-bokeo-teal-700 border px-3 py-3 text-left text-xs font-semibold sm:px-6 sm:py-4 sm:text-base">
                  Transfer Type
                </th>
                <th className="border-bokeo-teal-700 border px-3 py-3 text-center text-xs font-semibold sm:px-6 sm:py-4 sm:text-base">
                  Same Terminal
                </th>
                <th className="border-bokeo-teal-700 border px-3 py-3 text-center text-xs font-semibold sm:px-6 sm:py-4 sm:text-base">
                  Different Terminal
      ...
      <div className="rounded-xl border border-gray-200 bg-gradient-to-br from-gray-50 to-gray-100 p-4 sm:p-6">
        ...
        <div className="grid gap-3 sm:grid-cols-2 sm:gap-4">
          <div className="rounded-lg border border-gray-200 bg-white p-4 sm:p-5">
            <div className="flex items-start gap-3">
              <MapPin className="text-bokeo-teal-600 mt-1 h-4 w-4 flex-shrink-0 sm:h-5 sm:w-5" />
              <div>
                ...
                <p className="text-bokeo-teal-600 text-xs font-medium sm:text-sm">
          ...
          <div className="rounded-lg border border-gray-200 bg-white p-4 sm:p-5">
            <div className="flex items-start gap-3">
              <Users className="text-bokeo-teal-600 mt-1 h-4 w-4 flex-shrink-0 sm:h-5 sm:w-5" />
              <div>
                <h4 className="mb-1 text-sm font-semibold text-gray-900 sm:text-base">
                  Airport Information
                </h4>
