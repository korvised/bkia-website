          ...
          <div className="space-y-5 sm:space-y-6">
            ...
            <div className="flex gap-3 sm:gap-4">
              ...
              <div className="flex-grow pt-0.5 sm:pt-1">
                ...
                <p className="text-sm leading-relaxed text-gray-700 sm:text-base">
                  After disembarking, follow signs to the Transfer Counter
                  located in the main arrivals hall. The counter is open during
                  all flight operations and staffed by airline representatives.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-3 sm:gap-4">
              ...
              <div className="flex-grow pt-0.5 sm:pt-1">
                ...
                <p className="mb-3 text-sm leading-relaxed text-gray-700 sm:text-base">
                  Present your documents to receive your new boarding pass for
              ...
              <div className="space-y-3 text-sm text-gray-700 sm:text-base">
                <div>
                  ...
                  <p className="leading-relaxed">
                    If your baggage is checked through to your final
                    destination, inform the transfer counter staff. They will
                    coordinate the transfer for you – you don&#39;t need to
                    collect your bags.
                  </p>
                </div>
                <div>
