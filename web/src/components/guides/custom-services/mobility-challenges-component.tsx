    ...
    <>
      ...
      <section className="bg-[#f0fbfc] py-10">
        <div className="container">
          ...
          <p className="mb-2 text-xs font-bold tracking-widest text-[#00AAAC] uppercase">
            Custom Services
          </p>
          ...
          {/* Disclaimer */}
          <div className="mt-6 flex gap-3 rounded-r-lg border-l-4 border-amber-500 bg-amber-50 px-4 py-3">
        ...
        <div className="container">
          ...
          <div className="space-y-3">
            {requirements.map((req, i) => (
              <div
                key={i}
                className="flex gap-3 rounded-r-lg border-l-4 border-[#00AAAC] bg-[#f0fbfc] px-4 py-3"
              >
