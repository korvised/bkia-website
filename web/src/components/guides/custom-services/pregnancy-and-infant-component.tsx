    ...
    <>
      ...
      <section className="bg-[#003d3e]">
        ...
        >
          ...
          <p
            className="preg-anim mt-4 max-w-2xl text-sm leading-relaxed text-white/55 sm:text-base"
          ...
          {/* Disclaimer */}
          <div
            className="preg-anim mt-6 flex max-w-2xl gap-3 rounded-xl border border-amber-400/25 bg-amber-400/10 px-4 py-3.5"
