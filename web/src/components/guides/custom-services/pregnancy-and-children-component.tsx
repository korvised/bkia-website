      ...
      <div className="container space-y-6">
            ...
            {pregnancyRows.map(({ stage, info, status }, i) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="border-t border-gray-200 px-5 py-4 lg:border-t-0 lg:border-l">
        ...
        <div className="overflow-hidden rounded-2xl bg-white">
          ...
          <div className="lg:grid lg:grid-cols-2">
            <div className="relative min-h-64 bg-gray-100 lg:min-h-72">
              <Image
            ...
            <div className="flex flex-col justify-center gap-4 bg-gray-50 p-6 lg:p-8">
              <div className="flex gap-3">
                <div className="bg-primary-50 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg">
