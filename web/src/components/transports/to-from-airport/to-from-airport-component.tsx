...
import { Car, Bus, Phone, MessageCircle, MapPin, CreditCard, Info } from "lucide-react";
  ...
  return (
    <>
        ...
        <div className="container">
          <div className="grid items-center gap-10 lg:grid-cols-2">
            ...
            <div className="space-y-7">
              <div>
                <p className="mb-3 text-xs font-bold uppercase tracking-widest text-[#00AAAC]">{t.counterTitle}</p>
      ...
      <section className="bg-white py-10">
        <div className="container grid gap-12 lg:grid-cols-2">
          <div>
            ...
            <h2 className="mb-4 text-xl font-semibold text-gray-900">{t.ratesTitle}</h2>
          ...
          <div>
            ...
            <h2 className="mb-4 text-xl font-semibold text-gray-900">{t.paymentTitle}</h2>
      ...
      <section className="bg-gray-50 py-10">
        <div className="container">
          <p className="mb-1 text-xs font-bold uppercase tracking-widest text-[#00AAAC]">{t.featuresTitle}</p>
          <h2 className="mb-6 text-xl font-semibold text-gray-900">{t.featuresTitle}</h2>
      ...
      <section className="bg-[#00AAAC] py-12">
        <div className="container">
          <p className="mb-1 text-xs font-bold uppercase tracking-widest text-white/60">{t.bookingTitle}</p>
          <h2 className="mb-2 text-2xl font-bold text-white">{t.bookingTitle}</h2>
